...
all:
	...
	@echo ""
	@echo "  $(V)version$(N)     (solo releases) Genera la informacion de versión actualizada."
	@echo "  $(V)ver_sync$(N)    (solo releases) Sube la nueva version al servidor."
	@echo ""
...
distmac:
	@grunt nodewebkit
	mv distribuibles/ejemplo/osx/ejemplo.app distribuibles/ejemplo/osx/pilas-engine-bloques_0.1.5.app
	hdiutil create distribuibles/ejemplo/osx/pilas-engine-bloques_0.1.5.dmg -srcfolder distribuibles/ejemplo/osx/pilas-engine-bloques_0.1.5.app -size 200mb
	cp distribuibles/ejemplo/osx/pilas-engine-bloques_0.1.5.dmg '/Users/hugoruscitti/Google Drive/'
	cp distribuibles/ejemplo/osx/pilas-engine-bloques_0.1.5.dmg '/Users/hugoruscitti/shared/'
