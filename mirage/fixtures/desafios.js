...
/*  {
...

  {
    ...
    escena: `new EscenaCoty(0,100,
      ...
      [{x:0,y:100},{x:5,y:100},{x:10,y:100},{x:15,y:100},{x:20,y:100},{x:25,y:100},{x:30,y:100},{x:35,y:100},{x:40,y:100},{x:45,y:100},{x:50,y:100},{x:50,y:105},{x:50,y:110},{x:50,y:115},{x:50,y:120},{x:50,y:125},{x:50,y:130},{x:50,y:135},{x:50,y:140},{x:50,y:145},{x:50,y:150},{x:55,y:150},{x:60,y:150},{x:65,y:150},{x:70,y:150},{x:75,y:150},{x:80,y:150},{x:85,y:150},{x:90,y:150},{x:95,y:150},{x:100,y:150},{x:100,y:145},{x:100,y:140},{x:100,y:135},{x:100,y:130},{x:100,y:125},{x:100,y:120},{x:100,y:115},{x:100,y:110},{x:100,y:105},{x:100,y:100}]
    )`,
  ...
  },
  {
    ...
    imagen: 'Coty',
    escena: `new EscenaCoty(100,50,
      [],
      [[ {x:-150,y:50}, {x:-145,y:50}, {x:-140,y:50}, {x:-135,y:50}, {x:-130,y:50}, {x:-125,y:50}, {x:-120,y:50}, {x:-115,y:50}, {x:-110,y:50}, {x:-105,y:50}, {x:-100,y:50}],[ {x:-50,y:50}, {x:-45,y:50}, {x:-40,y:50}, {x:-35,y:50}, {x:-30,y:50}, {x:-25,y:50}, {x:-20,y:50}, {x:-15,y:50}, {x:-10,y:50}, {x:-5,y:50}, {x:0,y:50}],[ {x:50,y:50}, {x:55,y:50}, {x:60,y:50}, {x:65,y:50}, {x:70,y:50}, {x:75,y:50}, {x:80,y:50}, {x:85,y:50}, {x:90,y:50}, {x:95,y:50}, {x:100,y:50}]]
    )`,
    enunciado: 'COMPLETAR 1',
    consignaInicial: 'COMPLETAR 2',
    debeFelicitarse: true,
