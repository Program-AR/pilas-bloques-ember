declare class Estudiante {
    ...
    agregar_habilidad(habilidad_o_clase: any, argumentos: any): void;
    olvidar(habilidad_o_clase: any): void;
    getHabilidad(objetoOClase: any, argumentos: any): any;
    isClass(objeto: any): boolean;
    ...
    getClassName(obj?: Estudiante): string;
}
/**
 * @class Actor
 *
...
declare class Actor extends Estudiante {
    ...
    escalarAAncho(anchoDeseado: any): void;
    escalarAAlto(altoDeseado: any): void;
    rotacion: any;
...
declare class AtributoEntero {
    ...
    nuevoValor(victima: any): number;
}
declare class AtributoPorcentual {
    nombre: any;
    valorOriginalVictima: any;
    valorOriginalImitador: any;
    constructor(nombre: any, victima: any, imitador: any);
    nuevoValor(victima: any): number;
}
...
declare class ConstructorDePrograma {
    ...
    llamada_proc_primitivo(comportamiento: any, argsSinEvaluar: any): void;
    def_func(n: any): void;
...
declare class Pilas {
    ...
    ocultar(nombreDelModo: any): string;
    actualizar_modo(nombreDelModo: any, bool: any): void;
...
declare class Globo extends Actor {
    ...
    calcularY(): any;
    calcularX(): any;
    xADerechaDelActor(): any;
    xAIzquierdaDelActor(): number;
    ponerPuntita(): void;
    ponerPuntitaAIzquierda(): void;
    ponerPuntitaADerecha(): void;
    voyAIzquierda(): boolean;
    imagenPuntita(): {
        izquierda: string;
        derecha: string;
    };
