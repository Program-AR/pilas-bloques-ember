            ...
            <next>
               <block type="hasta" id="60" inline="true">
                  <value name="condition">
                     <block type="Estoyenunaesquina" id="62" />
                  </value>
         ...
         <block type="MoverACasillaArriba" id="208">
            <next>
               <block type="hasta" id="147" inline="true">
                  <value name="condition">
                     <block type="Estoyenunaesquina" id="149" />
                  </value>
                  <statement name="block">
         ...
         <block type="MoverACasillaAbajo" id="214">
            <next>
               <block type="hasta" id="85" inline="true">
                  <value name="condition">
                     <block type="Estoyenunaesquina" id="91" />
                  </value>
                  <statement name="block">
         ...
         <block type="MoverACasillaIzquierda" id="221">
            <next>
               <block type="hasta" id="154" inline="true">
                  <value name="condition">
                     <block type="Estoyenunaesquina" id="156" />
                  </value>
                  <statement name="block">
	...
	solucion: `<?xml version="1.0" encoding="UTF-8"?>
				<xml xmlns="http://www.w3.org/1999/xhtml">
   					...
   					<block type="al_empezar_a_ejecutar" id="f??M^^OalsGN9_LMY{!8" deletable="false" movable="false" editable="false" x="15" y="15">
      					<statement name="program">
         					<block type="PrenderCompu" id="0h,Qgm8I1;Z5CLtd[U(4" />
      					</statement>
					   </block>
				</xml>`,
});
...
actividadTest(nombre, {
	...
	solucion: '<xml xmlns="http://www.w3.org/1999/xhtml"><variables></variables><block type="al_empezar_a_ejecutar" id="m]4qN#uBu1{*2RN{P7b/" deletable="false" movable="false" editable="false" x="15" y="15"><statement name="program"><block type="MoverACasillaAbajo" id="Vcm9$Ds4ZHA8.%cgUoL3"><next><block type="PrenderCompu" id="G(LhjH54n`MKDK:OMZ=A"><next><block type="PrenderCompu" id="ob^9-_ZqX[Jc)c#+jt}F"></block></next></block></next></block></statement></block></xml>',
});
