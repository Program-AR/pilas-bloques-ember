...
moduloActividad(nombre, () => {
	...
	actividadTest(nombre, {
		...
		solucion: '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="al_empezar_a_ejecutar" id="|6JNA2=.$0V+DuSa+qbd" deletable="false" movable="false" editable="false" x="15" y="15"><statement name="program"><block type="MoverACasillaDerecha" id="%eFKw~*o-wfmLXO6!mj-"><next><block type="procedures_callnoreturn" id="AYf_-:#ke?O[B%eSMVbF"><mutation name="COMER NARANJA SI HAY"></mutation><next><block type="Repetir" id="rUDq?uw@/D8{E|%Pi3;Z"><value name="count"><block type="math_number" id="QSA_?glC*rzkx/.H#tUJ"><field name="NUM">3</field></block></value></block></next></block></next></block></statement></block><block type="procedures_defnoreturn" id="FMF7V%|312bV)g_h5D9$" x="310" y="26"><field name="NAME">COMER NARANJA SI HAY</field><comment pinned="false" h="80" w="160">Describe esta funcin...</comment><statement name="STACK"><block type="Si" id="Cvp$!KL$T-SjO2Y?kp/e"><value name="condition"><block type="TocandoNaranja" id="UV9d54{l/1o.jiYP+p@5"></block></value><statement name="block"><block type="ComerNaranja" id="dJ5?cn([fcvs%EZr~DEO"></block></statement></block></statement></block></xml>',
		resuelveDesafio: false,
	});
