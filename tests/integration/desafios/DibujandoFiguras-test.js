...
actividadTest('DibujoLibre', {
  ...
  solucion: '<xml xmlns="http://www.w3.org/1999/xhtml"><variables></variables><block type="al_empezar_a_ejecutar" id="Yy2EX{v4UBA`ia;S3H5)" deletable="false" movable="false" editable="false" x="15" y="15"><statement name="program"><block type="repetir" id="`J];0dS4[}mgGgC3}ieG"><value name="count"><block type="OpAritmetica" id="0FM417ox1a=?rsjJn4yr"><field name="OP">ADD</field><value name="A"><block type="Numero" id="DU0^eA,9L3H:v{Fe=LUi"><field name="NUM">1</field></block></value><value name="B"><block type="Numero" id="A4FNJK1zuC=nmPo528:U"><field name="NUM">2</field></block></value></block></value><statement name="block"><block type="procedures_callnoreturn" id="fg(KTuM@_1!%a7[G7cb|"><mutation name="Dibujar mover y saltar"></mutation></block></statement></block></statement></block><block type="procedures_defnoreturn" id="2/*!K6:?tZp7bi/|/ap~" x="647" y="-7"><field name="NAME">Dibujar mover y saltar</field><comment pinned="false" h="80" w="160">Describe esta funcin...</comment><statement name="STACK"><block type="DibujarLado" id="`9H={``=-m`Uve`Byo:8"><value name="longitud"><block type="math_number" id="g2/ho73EK!N@NKyc-M4u"><field name="NUM">75</field></block></value><next><block type="GirarGrados" id="NCa*#nhe8n(zodbA9zCE"><value name="grados"><block type="math_number" id="exccxvn-249l#fBRJ`3t"><field name="NUM">90</field></block></value><next><block type="SaltarHaciaAdelante" id="dQA13Xj-:5bs%W=khbf1"><value name="longitud"><block type="math_number" id="uwExc^5leF,t.Qe0kdZw"><field name="NUM">100</field></block></value><next><block type="GirarGrados" id="seCMVc(Stl2Ir+xvi5j5"><value name="grados"><block type="math_number" id="y9([fd{As0e86N^xRE=J"><field name="NUM">90</field></block></value><next><block type="DibujarLado" id="fr5,FlC?[k3[n!5xhKtQ"><value name="longitud"><block type="math_number" id="jW0B?u5P$J9M44-/~(6)"><field name="NUM">75</field></block></value><next><block type="GirarGrados" id="XUWSsUEtIzL[Zc(4ZR28"><value name="grados"><block type="math_number" id="SC{)d(=DngvXgDiE47`4"><field name="NUM">90</field></block></value><next><block type="SaltarHaciaAdelante" id="DKEkD+rStAawI]bm#N9N"><value name="longitud"><block type="math_number" id="0tRaLfd(%@r|6F=PgZX{"><field name="NUM">100</field></block></value><next><block type="GirarGrados" id="~A4Rsxa5TPo8L35TuF+d"><value name="grados"><block type="math_number" id="Bl,yaj,TTA.W)3~cUHhH"><field name="NUM">90</field></block></value></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></statement></block></xml>',
  resuelveDesafio: false,
});
