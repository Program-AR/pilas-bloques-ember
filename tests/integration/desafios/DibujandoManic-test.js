...
moduloActividad('DibujandoRayuelaRoboticaManic', () => {
  ...
  actividadTest('DibujandoRayuelaRoboticaManic', {
    solucion: `<xml xmlns="http://www.w3.org/1999/xhtml">
...
moduloActividad('DibujandoCortoPorLaDiagonalManic', () => {
  ...
  actividadTest('DibujandoCortoPorLaDiagonalManic', {
...
moduloActividad('DibujandoMamushkaCuadradaManic', () => {

  actividadTest('DibujandoMamushkaCuadradaManic', {
...
moduloActividad('DibujandoEscaleraCuadradaManic', () => {

  actividadTest('DibujandoEscaleraCuadradaManic', {
...
moduloActividad('DibujandoHexagonoManic', () => {

  actividadTest('DibujandoHexagonoManic', {
...
moduloActividad('DibujandoPiramideInvertidaManic', () => {
  ...
  actividadTest('DibujandoPiramideInvertidaManic', {
...
moduloActividad('DibujandoFigurasDentroDeFigurasManic', () => {

  actividadTest('DibujandoFigurasDentroDeFigurasManic', {
...
moduloActividad('DibujandoLaCuevaDeEstalagtitasManic', () => {

  actividadTest('DibujandoLaCuevaDeEstalagtitasManic', {
...
moduloActividad('DibujoLibreManic', () => {

  actividadTest('DibujoLibreManic', {
